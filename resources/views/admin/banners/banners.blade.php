        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a style="max-width:150px;float:right;disply:inline-block;" class="btn btn-block btn-primary" href="{{ url('admin/add-edit-banners') }}">Add Banner</a>
                  ...
                  <div class="table-responsive pt-3">
                    <table id="section" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{$banner['id']}}</td>
                          <td><img src="{{ asset('front/images/banner_image/'.$banner['image']) }}"></td>
                          <td>{{$banner['type']}}</td>
                          <td>{{$banner['link']}}</td>
                          <td>{{$banner['title']}}</td>
                          <td>{{$banner['alt']}}</td>
                          ...
                          <td>
                            <a href="{{url('admin/add-edit-banners/'.$banner['id'])}}">
